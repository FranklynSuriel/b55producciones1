...
/*--------------------------------------------------------------*/
 ...
 function updateLastLogIn($user_id)
  ...
  function page_require_level($require_level){
   ...
   /*--------------------------------------------------------------*/
   function join_presupuesto() {
    global $db;
    $sql  = "SELECT p.id, p.client_id, p.project_name, p.creation_date, p.due_date, p.global_total, p.impuesto,p.imprevisto, p.total_presupuestado, c.client_name ";
    $sql .= "FROM presupuesto p ";
    $sql .= "JOIN clientes c ON p.client_id = c.id ";
    $sql .= "ORDER BY p.client_id ASC";
